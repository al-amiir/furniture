...
const Home = () => {
  return (
    <Box sx={{ backgroundColor: "black", height: "100vh", width: "100vw", backgroundPosition: "bottom", backgroundSize: "cover", overflow: "hidden", display: "flex", justifyContent: "center", alignItems: "center" }}>
